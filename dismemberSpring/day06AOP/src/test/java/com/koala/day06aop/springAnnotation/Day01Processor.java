...
import com.koala.day06aop.springComponents.springBeans.factory.parsing.EmptyReaderEventListener;
import com.koala.day06aop.springComponents.springBeans.factory.parsing.ReaderEventListener;
import com.koala.day06aop.springComponents.springBeans.factory.support.DefaultListableBeanFactory;
import com.koala.day06aop.springComponents.springBeans.factory.xml.BeanDefinitionParserDelegate;
import com.koala.day06aop.springComponents.springBeans.factory.xml.DefaultNamespaceHandlerResolver;
import com.koala.day06aop.springComponents.springBeans.factory.xml.NamespaceHandlerResolver;
import com.koala.day06aop.springComponents.springBeans.factory.xml.XmlBeanDefinitionReader;
import com.koala.day06aop.springComponents.springBeans.factory.xml.XmlReaderContext;
...
import com.koala.day06aop.springComponents.springContext.context.support.ApplicationContextAwareProcessor;
import com.koala.day06aop.springComponents.springContext.context.support.ApplicationListenerDetector;
import com.koala.day06aop.springComponents.springContext.context.support.ClassPathXmlApplicationContext;
import com.koala.day06aop.springComponents.springContext.context.support.DefaultLifecycleProcessor;
import com.koala.day06aop.springComponents.springContext.context.support.PostProcessorRegistrationDelegate;
import com.koala.day06aop.springComponents.springCore.core.io.ProtocolResolver;
import com.koala.day06aop.springComponents.springCore.core.io.ResourceLoader;
...
public class Day01Processor {
    ...
    public void refresh() {
        ...
        // 核心：此处打断点进行查看 + processor目录下的所有类打断点查看
    ...
    public void prepareBeanFactory(AbstractApplicationContext applicationContext) {
        ...
        beanFactory.addBeanPostProcessor(new ApplicationContextAwareProcessor(applicationContext)); //day20：准备一个处理Aware接口功能的后置处理器
