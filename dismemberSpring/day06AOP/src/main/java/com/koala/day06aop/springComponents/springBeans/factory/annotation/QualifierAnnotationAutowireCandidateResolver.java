...
import com.koala.day06aop.springComponents.springBeans.factory.support.GenericTypeAwareAutowireCandidateResolver;
    ...
    public QualifierAnnotationAutowireCandidateResolver() {
        ...
        try {
            this.qualifierTypes.add((Class<? extends Annotation>) ClassUtils.forName("javax.inject.Qualifier",
                    org.springframework.beans.factory.annotation.QualifierAnnotationAutowireCandidateResolver.class.getClassLoader()));
        }
